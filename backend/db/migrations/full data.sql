...
CREATE TABLE tickets (
    ...
    status        ENUM('BOOKED', 'HOLD', 'CONFIRMED', 'EXPIRED', 'PAID', 'CANCELLED', 'REFUNDED') NOT NULL DEFAULT 'BOOKED',
    booked_by     BIGINT,
...
(SELECT 'A' row_n UNION SELECT 'B' UNION SELECT 'C' UNION SELECT 'D' UNION SELECT 'E' UNION SELECT 'F' UNION SELECT 'G' UNION SELECT 'H' UNION SELECT 'I' UNION SELECT 'J' UNION SELECT 'K' UNION SELECT 'L') AS row_data
CROSS JOIN (SELECT '1' seat_n, 0 x, 0 y UNION SELECT '2', 1, 0) AS col_data;
...
(SELECT 'A' row_n UNION SELECT 'B' UNION SELECT 'C' UNION SELECT 'D' UNION SELECT 'E' UNION SELECT 'F' UNION SELECT 'G' UNION SELECT 'H' UNION SELECT 'I' UNION SELECT 'J' UNION SELECT 'K' UNION SELECT 'L' UNION SELECT 'M' UNION SELECT 'N' UNION SELECT 'O' UNION SELECT 'P' UNION SELECT 'Q' UNION SELECT 'R') AS row_data
CROSS JOIN (SELECT '1' seat_n, 0 x, 0 y UNION SELECT '2', 1, 0) AS col_data;
...
(SELECT 'A' row_n UNION SELECT 'B' UNION SELECT 'C' UNION SELECT 'D' UNION SELECT 'E' UNION SELECT 'F' UNION SELECT 'G' UNION SELECT 'H' UNION SELECT 'I' UNION SELECT 'J' UNION SELECT 'K' UNION SELECT 'L' UNION SELECT 'M' UNION SELECT 'N' UNION SELECT 'O' UNION SELECT 'P' UNION SELECT 'Q' UNION SELECT 'R' UNION SELECT 'S' UNION SELECT 'T') AS row_data
CROSS JOIN (SELECT '1' seat_n, 0 x, 0 y UNION SELECT '2', 1, 0) AS col_data;
...
(SELECT 'A' row_n UNION SELECT 'B' UNION SELECT 'C' UNION SELECT 'D' UNION SELECT 'E' UNION SELECT 'F' UNION SELECT 'G' UNION SELECT 'H' UNION SELECT 'I' UNION SELECT 'J' UNION SELECT 'K' UNION SELECT 'L' UNION SELECT 'M' UNION SELECT 'N' UNION SELECT 'O') AS row_data
CROSS JOIN (SELECT '1' seat_n, 0 x, 0 y UNION SELECT '2', 1, 0 UNION SELECT '3', 2, 0) AS col_data;
...
(SELECT 'A' row_n UNION SELECT 'B' UNION SELECT 'C' UNION SELECT 'D' UNION SELECT 'E' UNION SELECT 'F' UNION SELECT 'G' UNION SELECT 'H' UNION SELECT 'I' UNION SELECT 'J' UNION SELECT 'K' UNION SELECT 'L' UNION SELECT 'M' UNION SELECT 'N' UNION SELECT 'O' UNION SELECT 'P') AS row_data
CROSS JOIN (SELECT '1' seat_n, 0 x, 0 y UNION SELECT '2', 1, 0 UNION SELECT '3', 2, 0) AS col_data;
